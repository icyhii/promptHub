/*
  ...
  2. Enums
    - team_visibility: public, private
  ...
  3. Security
    ...
    - Secure function for team creation
*/

-- Create enums first to avoid type casting issues
...
-- Create indexes (with IF NOT EXISTS to prevent errors)
...
-- Update existing team_members table to use new role enum
