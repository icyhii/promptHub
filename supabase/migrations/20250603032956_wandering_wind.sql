/*
  ...
  1. New Types
    - team_visibility enum ('public', 'private')
    - invitation_status enum ('pending', 'accepted', 'declined', 'revoked')
    - team_role enum ('owner', 'admin', 'editor', 'viewer')

  2. New Tables
    - team_settings (team configuration)
    - team_invitations (pending team invites)
    - team_audit_logs (security audit trail)

  3. Security
    - Enable RLS on all tables
    - Add policies for team admins and members
*/
